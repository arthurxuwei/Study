...
var imgData = new Array(
		{type:"js",path:"/static/scripts/lufylegend/lib/Box2dWeb-2.1.a.3.min.js"},
		{type:"js",path:"/static/scripts/Bird.js"},
		{type:"js",path:"/static/scripts/Pig.js"},
		{type:"js",path:"/static/scripts/Stage.js"},
		{type:"js",path:"/static/scripts/RemoveObject.js"},
		{name:"back",path:"/static/images/back.png"},
		{name:"bird1",path:"/static/images/bird1.png"},
		{name:"slingshot1",path:"/static/images/slingshot1.png"},
		{name:"slingshot2",path:"/static/images/slingshot2.png"},
		{name:"remove",path:"/static/images/remove.png"},
		{name:"pig01",path:"/static/images/pig01.png"},
		{name:"pig02",path:"/static/images/pig02.png"},
		{name:"st01",path:"/static/images/st01.png"},
		{name:"st02",path:"/static/images/st02.png"},
		{name:"st11",path:"/static/images/st11.png"},
		{name:"st12",path:"/static/images/st12.png"},
		{name:"st21",path:"/static/images/st21.png"},
		{name:"st22",path:"/static/images/st22.png"},
		{name:"st31",path:"/static/images/st31.png"},
		{name:"st32",path:"/static/images/st32.png"},
		{name:"desk",path:"/static/images/desk.png"}
		);
var startX,startY;
function main(){
	if(LGlobal.canTouch){
