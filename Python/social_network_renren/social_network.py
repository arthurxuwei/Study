...
username = 'xueshanfeihu4321@sina.com'
password = 'xw007110'
...
def getgraph(username, password):
	...
	for uid1, uname1 in dict_root.items():
		#Encode Chinese characters for matplotlib 
...
def draw_graph(username, password, filename='graph.txt', label_flag=True, remove_isolated=True,
				different_size=True, iso_level=10, node_size=40):
	'''Reading data from file and draw the graph. If not exists, create the file and
		re-scratch data from net
	'''
