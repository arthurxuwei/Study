...
(** Third, we can ask Coq to "extract," from a [Definition], a
    ...
    and Cast茅ran, as well as the Coq reference manual. *)
...
(**这里既可以不是bool true false 无所谓什么形式，只是定义了两种不同的情况
   example：
...
(**define a color type
  Inductive color : Type :=
    | red : color
    | black : color.
  Here,you define a red-black tree ,8 line enough*)


(**true false | neg and or 即组成一个形式系统 = 数据类型 ： 布尔代数*)
...
(*fixpoint（不动点） 有限递归 F#let rec f(x) = ...可以无限调用*)
(**非良型
...
Theorem zero_nbeq_plus_1 : forall n : nat,
  beq_nat 0 (n + 1) = false.
Proof.
  (* FILL IN HERE *)intros n. destruct n as [| n'].
                    reflexivity.
                    reflexivity.  Qed.
(** [] *)
...
Theorem mult_0_r : forall n:nat,
  n * 0 = 0.
Proof.
  (* FILL IN HERE *) intros n. induction n as [| n'].
                     Case "n = 0".
                     simpl. reflexivity.
                     Case "n = S n'".
                     simpl. rewrite -> IHn'. reflexivity. Qed.
...
Theorem plus_n_Sm : forall n m : nat, 
  S (n + m) = n + (S m).
Proof. 
  (* FILL IN HERE *) intros n m. induction n as [| n'].
                     Case "n = 0".
                     simpl. reflexivity.
                     Case "n = S n'".
                     simpl. rewrite -> IHn'. reflexivity. Qed.
...
Proof.
  (* FILL IN HERE *) intros n m. induction n as [| n'].
                     Case "n = 0".
                       simpl. rewrite -> plus_0_r_secondtry.
                       reflexivity.
                     Case "n = S n'".
...
(* FILL IN HERE *)
  [destruct]会自动填充变量，可以忽略[as]...[induction]可以rewrite
*)
(** [] *)
...
(** Now prove commutativity of multiplication.  (You will probably
    ...
    handy. *)
Theorem mult_comm_pre : forall m n : nat,
  n + n * m = n * (1 + m).
Proof.
...
Theorem mult_comm : forall m n : nat,
 m * n = n * m.
Proof.
  (* FILL IN HERE *) intros m n. induction m as [| m'].
...
Proof.
  (* FILL IN HERE *)assert (H: forall (b : bool), negb (negb b) = b).
                       Case "Proof of assertion".
                       intros b.
...
Theorem andb_false_r : forall b : bool,
  andb b false = false.
Proof.
  (* FILL IN HERE *) intros b. destruct b.
                     simpl. reflexivity.
                     simpl. reflexivity.
                     Qed.
...
Proof.
  (* FILL IN HERE *) intros n m p H. induction p as [| p'].
                     Case "p = 0".
...
Theorem S_nbeq_0 : forall n:nat,
  beq_nat (S n) 0 = false.
Proof.
  (* FILL IN HERE *) intros n. destruct n.
                     simpl. reflexivity.
                     simpl. reflexivity.
                     Qed.
...
Theorem mult_plus_distr_r : forall n m p : nat,
  (n + m) * p = (n * p) + (m * p).
Proof.
  (* FILL IN HERE *) intros n m p. induction n as [| n'].
                     simpl. reflexivity.
                     Case "n = S n'".
                       simpl. rewrite -> IHn'.
                       rewrite -> plus_assoc.
